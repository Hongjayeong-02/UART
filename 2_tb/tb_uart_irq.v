...
initial begin
        ...
        // NOTE: o_irqStatus[1] is a registered (posedge-clk) level bit in
        // this RTL revision, so a clock edge must elapse before the new
        // i_txFifoEmpty value is reflected in o_irqStatus.
        r_txFifoEmpty = 1'b0;
        ...
        // RX data arrives
        // NOTE: o_irqStatus[0] is also a registered level bit — wait a
        // clock edge before sampling.
        r_rxFifoEmpty = 1'b0;
        ...
        // NOTE: status bits [1:0] are registered level bits — wait a
        // clock edge for them to update before checking.
        @(posedge clk);
        #1;
