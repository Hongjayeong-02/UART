...
task send_and_check;
        ...
        reg     [7:0]   capturedRxData;
        reg             capturedParityErr;
        reg             capturedFrameErr;
        ...
        begin
                ...
                fork
                        ...
                        begin : catch_rx_valid
                                @(posedge w_rxValid);

                                capturedRxData    = w_rxData;
                                capturedParityErr = w_parityErr;
                                capturedFrameErr  = w_frameErr;
                        end
                ...
                // RX Data Check
                if (capturedRxData !== expectedData) begin
                ...
                // Parity Error Check
                if (capturedParityErr !== expectedParityErr) begin
                ...
                // Frame Error Check
                if (capturedFrameErr !== expectedFrameErr) begin
